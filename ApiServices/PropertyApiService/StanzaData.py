...
def PropertyData():
    ...
    city_ids = [
        city.get("city_id") for city in collection.find({}, {"city_id": 1, "_id": 0})
    ]
    ...
    for city_id in city_ids:
        params = {"city": str(city_id), "pageNo": "1", "pageSize": "100"}
        ...
        try:
            ...
            for property in properties:
                ...
                amenities = (
                    formatted_result_for_amenity_1 + formatted_result_for_amenity_2
                )
            ...
            print(
                f"An error occurred while making the API request for city {city_id}: {e}"
            )
